...
// Длительность тика 1t (уведомление импульсом - 0,18 c) (наносекунды)
#define DUR_TICK_T 180000000
...
int main(int argc, char *argv[]) {
	...
	int pidP2 = spawnl( P_NOWAIT, "/home/host/vika/lab3p2/x86/o/lab3p2", chIdStr, NULL);
	if (pidP2 < 0){
