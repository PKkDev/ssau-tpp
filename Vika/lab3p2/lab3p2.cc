...
#define TREND_FILE "/home/host/vika/lab3Trend/trend.txt"
...
int main(int argc, char *argv[]) {
	...
	int pidP1 = spawnl( P_NOWAIT, "/home/host/vika/lab3p1/x86/o/lab3p1",(char*)"", NULL);
	if (pidP1 < 0){
		cout << "P2: Ошибка запуска процесса P1 " << strerror(pidP1) << endl;
		exit(EXIT_FAILURE);
	}
	cout << "P2: pid процесса P1 - " << pidP1 <<  endl;
	...
	// величина тика из нсек в сек 400000000 нсек -> 0,4 сек
